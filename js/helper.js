...
var HTMLworkLink = '<a href="%link%" target="_blank">More Info</a>';

var HTMLprojectStart = '<div class="project-entry"></div>';
var HTMLprojectTitle = '<a>%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<div class="white-text"><br>%data%</div>';
var HTMLprojectImage = '<img src="%data%" width=25% height=25%>';
